...
try{
 ...
 await page.evaluate(()=>{lmnWorkspace.navigatorMode='library';lmnWorkspace.renderNavigator();document.querySelector('#navigatorContent').scrollTop=0});assert.ok(await page.locator('.template-semantic-preview').count()>=12);await page.screenshot({path:'qa-output/library.png'});

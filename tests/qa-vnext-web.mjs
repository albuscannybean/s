...
try{
 ...
 assert.equal(result.surface.dimension,'2d');assert.equal(result.surface.plots,1);assert.deepEqual(result.surface.errors,[]);await page.screenshot({path:'qa-output/math-workbench.png'});

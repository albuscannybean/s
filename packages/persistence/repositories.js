...
export class SearchRepository{
  ...
  async text(query){return textSearch(query,await this.state())}async structure(criteria){return structureSearch(criteria,await this.state())}async pattern(pattern){return patternSearch(pattern,await this.state())}
}

...
function drawEdges(layer,scene,options){
  layer.replaceChildren();markerDefs(layer);const selected=new Set(options.selectedIds??[]),occupiedLabels=[],labelLayer=svg('g');labelLayer.classList.add('relation-label-layer');

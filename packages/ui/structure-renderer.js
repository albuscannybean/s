...
function drawEdges(layer,scene,options){
  layer.replaceChildren();markerDefs(layer);drawColumnAxes(layer,scene);const selected=new Set(options.selectedIds??[]),occupiedLabels=[];

...
export const LKL_SCHEMA=Object.freeze({
  ...
  declarations:{
    ...
    'structure-instance':{required:['using'],fields:['using','owner','title','parameter','container','variable','geometry','runtime','design','visibility']},
    geometry:{required:['type','point'],fields:['type','point','visible','stroke','width','fill']},

...
export function parseLkl2(source){
  ...
  const parseBlock=(kind,id,loc)=>{expect('lbrace');const block={kind:kind==='instance'?'structure-instance':kind,id:id??null,statements:[],children:[],loc};skipLines();while(current().type!=='rbrace'&&current().type!=='eof'){

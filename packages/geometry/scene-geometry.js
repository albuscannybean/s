...
export function fitScene(scene,viewport,padding=72){
  const zoom=clamp(Math.min((viewport.width-padding*2)/scene.bounds.width,(viewport.height-padding*2)/scene.bounds.height),.015,2.5);
